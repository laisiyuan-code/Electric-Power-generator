...
## Key Considerations
- **Thermal Conductivity**: Copper is chosen for its excellent heat transfer, ensuring efficient cooling from bottle to IPA.
- **Safety**: IPA is flammable, so care is taken with sealed tubing and no ignition sources.
- **Alternative Coolants**: While IPA is effective, a water-glycol mix could be safer, reducing flammability.
- **Fan Cooling Efficiency**: The fan and radiator need to dissipate heat at a rate that keeps the IPA cool enough for the next cycle.
